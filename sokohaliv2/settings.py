"""
Django settings for sokohaliv2 project.
...
DEFAULT_FROM_EMAIL  = 'volkmannexpress <info@volkmannexpress.com>'
...
if os.environ.get('RDS_DB_NAME'):
    ...
    FLUTTERWAVE_API_KEY         = "lk_kgmPDGxNSCe3F8EhWLzb"
    FLUTTERWAVE_MERCHANT_KEY    = "lk_ON6QkUCSV5"
    ...
    # ('Uchechukwu Ohaukwu', 'uchechukwu.ca@gmail.com'),
    )
    ...
    #         'NAME': 'nruzo', 
    #         # 'NAME': 'SOKOHALIVR2_DB',               #'newCA_db',   # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = [
        ...
        '.volkmannexpress.com',
         ...
         # '.adisenergy.com',
         # 'www.adisenergy.com',
         'freightforwarder-env.eu-west-1.elasticbeanstalk.com',
...
Sokohaliv2_APPS = (
    ...
    'payment',
    'service_provider',
    #django.contrib.admin is here because of reset password template override and RuntimeError populate isnt reentrant error
...
if not os.environ.get('RDS_DB_NAME'):
    EXTERNAL_APPS+=('debug_toolbar',)# 'cities_light',)
    #Test Site
    NORECAPTCHA_SITE_KEY = "6LeMdRUTAAAAAEZwmFKVyjZHefPnVGJersey3-RN"
    NORECAPTCHA_SECRET_KEY = "6LeMdRUTAAAAAGDDmsR8lYBaKp8M4dmofDPN29sG"
else:
    #Live Site
    NORECAPTCHA_SITE_KEY = "6LcjfyETAAAAAFr69fJbqjjiPkq9MTnE1XHf24OQ"
    NORECAPTCHA_SECRET_KEY = "6LcjfyETAAAAADvm66JrJ0NExUjbu9lzLwlGYBiD"


INSTALLED_APPS = DJANGO_APPS + Sokohaliv2_APPS + EXTERNAL_APPS
...
MIDDLEWARE_CLASSES = [
    ...
    'service_provider.middleware.subdomain.SubDomainMiddleware',
    'service_provider.middleware.exceptions.ExceptionMiddleware',
...
ROOT_URLCONF = 'sokohaliv2.urls'

WSGI_APPLICATION = 'sokohaliv2.wsgi.application'
...
PAYPAL_RECEIVER_EMAIL = 'info@volkmannexpress.com'
PAYPAL_RETURN_URL = "https://www.volkmannexpress.com/confirm_paypal_payment/"
