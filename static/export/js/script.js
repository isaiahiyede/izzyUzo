...
try{
  ...
  console.log('script.js error: ' + err.message);
}
...
$('.shipment .item .out .history').click(function () {
    $(this).parent().parent().toggleClass('active');
...
/* Worldwide Steps Script */
//$('.form.two .checkbox.t label').click(function () {
//    $(this).parent().toggleClass('active');
//    $('.form.addrs#newaddrs').toggleClass('active');
//});

/* Script to toggle location based on dropdown */
$('#state_select .custom-option').click(function () {
    $('.location .loc').removeClass('active');
    $('.loc#' + $(this).attr('data-value')).toggleClass('active')
});
