	...
	$.fn.paulund_modal_box = function(prop){
		 ...
		 */
		 ...
		 function add_popup_box(){
			 ...
			 var pop_up = $('<div class="paulund_modal_box"><div class="paulund_inner_modal_box"><h2>' + options.title + '</h2><p>' + '<a href="http://localhost:8000/pattern/check_result/" class="btn btn-primary">check_result</a>' + options.description + '</p></div> </div>');
