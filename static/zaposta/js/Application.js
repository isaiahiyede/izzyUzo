...
app.config(['$routeProvider', function($routeProvider){
        $routeProvider.
                when('/', {templateIrl: 'pages/lists.html', controller: 'CustomerListController'}).
                when('/NewCustomer', {templateUrl: 'pages/new.html', controller: 'CustomerAddController'}).
                when('/UpdateCustomer/:id', {templateUrl: 'pages/edit.html', controller: 'CustomerEditController'}).
...
app.controller('CustomerListController', [
        '$scope', '$http',
        function ($scope, $http){
                $http.get('shipping/get-user-items/').success(function(data){
...
app.controller('CustomerAddController', [
        '$scope', '$http', '$location',
